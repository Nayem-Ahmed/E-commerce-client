                    ...
                    <div className="md:w-1/2 mt-8 md:mt-0">
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <div className="flex items-center mb-3">
                                <FaMapMarkerAlt className="h-6 w-6 mr-3 text-gray-600" />
                                <span className="text-lg text-gray-700">123 Main Street, New York, NY 10001</span>
                            </div>
                            <div className="flex items-center mb-3">
                                <FaEnvelope className="h-6 w-6 mr-3 text-gray-600" />
                                <span className="text-lg text-gray-700">contact@example.com</span>
                            </div>
                            <div className="flex items-center">
                                <FaPhone className="h-6 w-6 mr-3 text-gray-600" />
