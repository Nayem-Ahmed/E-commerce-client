...
const KidDetails = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const { _id, ...detailsWithoutId } = kiddetails;
            const addCartData = {
                ...detailsWithoutId,
                size: selectedSize,
                quantity: quantity,
                ...
                <div className="flex flex-col justify-between">
                    <div>
                        ...
                        <div className="flex items-center mb-4">
                            <p className="text-lg font-semibold text-[#eb2f06] mr-2">${kiddetails.new_price}</p>
                            <p className="text-sm text-gray-500 line-through">${kiddetails.old_price}</p>
                        </div>
